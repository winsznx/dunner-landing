        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              required
              className="flex-1 bg-[#1A1A1E] border border-[#3A3A3F] text-[#EEEEEF] placeholder-[#6C6C74] px-5 py-3.5 rounded-full text-sm outline-none focus:border-[#22D3EE] transition-colors"
            />
            <button
              type="submit"
